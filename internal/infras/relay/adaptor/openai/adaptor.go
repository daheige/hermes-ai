...
func NewAdaptor(tc *TokenCounter) *Adaptor {
...
func (a *Adaptor) SetupRequestHeader(c *gin.Context, req *http.Request, meta *meta.Meta) error {
	...
	if meta.ChannelType == channeltype.OpenRouter {
		// req.Header.Set("HTTP-Referer", "https://hermes-ai")
		req.Header.Set("X-Title", "hermes-ai")
	}
	return nil
}
...
func (a *Adaptor) ConvertRequest(c *gin.Context, relayMode int, request *model2.GeneralOpenAIRequest) (any, error) {
	...
	if request.Stream {
		...
		if request.StreamOptions == nil {
			request.StreamOptions = &model2.StreamOptions{}
		}
