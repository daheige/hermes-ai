...
func StreamResponseCohere2OpenAI(cohereResponse *StreamResponse) (*openai2.ChatCompletionsStreamResponse, *Response) {
...
func ResponseCohere2OpenAI(cohereResponse *Response) *openai2.TextResponse {
