...
func responseBaidu2OpenAI(response *ChatResponse) *openai2.TextResponse {
...
func streamResponseBaidu2OpenAI(baiduResponse *ChatStreamResponse) *openai2.ChatCompletionsStreamResponse {
...
func embeddingResponseBaidu2OpenAI(response *EmbeddingResponse) *openai2.EmbeddingResponse {
...
func getBaiduAccessTokenHelper(apiKey string) (*AccessToken, error) {
	...
	res, err := httpclient.ImpatientHTTPClient.Do(req)
	if err != nil {
		return nil, err
	}
