...
func (*Adaptor) ConvertImageRequest(request *model2.ImageRequest) (any, error) {
...
func (a *Adaptor) DoRequest(c *gin.Context, meta *meta.Meta, requestBody io.Reader) (*http.Response, error) {
	slog.With("request_id", logger.GetRequestID(c.Request.Context())).Info("send request to replicate")
