...
func AddNewMissingRatio(oldRatio string) string {
	...
	if err != nil {
		slog.Error("error unmarshalling old ratio: " + err.Error())
		return oldRatio
	}
	...
	if err != nil {
		slog.Error("error marshalling new ratio: " + err.Error())
		return oldRatio
	}
...
func ModelRatio2JSONString() string {
	...
	if err != nil {
		slog.Error("error marshalling model ratio: " + err.Error())
	}
	return string(jsonBytes)
}
...
func GetModelRatio(name string, channelType int) float64 {
	...
	slog.Error("model ratio not found: " + name)
	return 30
}
...
func CompletionRatio2JSONString() string {
	...
	if err != nil {
		slog.Error("error marshalling completion ratio: " + err.Error())
	}
	return string(jsonBytes)
}
