...
func InitRedisClient() (err error) {
	...
	if os.Getenv("SYNC_FREQUENCY") == "" {
		RedisEnabled = false
		log.Println("SYNC_FREQUENCY not set, Redis is disabled")
		return nil
	}
	...
	if os.Getenv("REDIS_MASTER_NAME") == "" {
		...
		if err != nil {
			log.Fatalln("failed to parse Redis connection string: " + err.Error())
		}
	...
	if err != nil {
		log.Fatalln("Redis ping test failed: " + err.Error())
	}
	return err
}
