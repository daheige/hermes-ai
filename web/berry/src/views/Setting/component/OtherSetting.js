...
const OtherSetting = () => {
  ...
  const openGitHubRelease = () => {
    window.location = 'https://github.com/daheige/hermes-ai/releases/latest';
  };

  const checkUpdate = async () => {
    const res = await API.get('https://github.com/daheige/hermes-ai/releases/latest');
          ...
          <Grid container spacing={{ xs: 3, sm: 2, md: 4 }}>
            ...
            <Grid xs={12}>
              <Alert severity="warning">
                移除 hermes-ai 的版权标识必须首先获得授权，项目维护需要花费大量精力，如果本项目对你有意义，请主动支持本项目。
              </Alert>
            </Grid>
            <Grid xs={12}>
              <FormControl fullWidth>
