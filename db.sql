...
-- Create syntax for TABLE 'abilities'
CREATE TABLE `abilities` (
     `group` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `channels` (
    ...
    `key_hash` char(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `logs` (
    ...
    `request_id` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
...
-- Create syntax for TABLE 'redemptions'
...
CREATE TABLE `tokens` (
    ...
    `subnet` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
    PRIMARY KEY (`id`),
